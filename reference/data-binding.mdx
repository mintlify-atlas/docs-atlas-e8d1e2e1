...
description: "A2UI data binding with JSON Pointer paths: bind component properties to live state, send updateDataModel messages, render dynamic lists, and sync inputs."
---
