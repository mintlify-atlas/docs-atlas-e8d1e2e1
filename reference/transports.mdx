...
description: "A2UI transports—A2A Protocol, AG-UI, REST, WebSockets, SSE—with status, use cases, and guidance on selecting the right message delivery mechanism."
---
