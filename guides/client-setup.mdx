...
description: "Install and configure an A2UI renderer for React, Lit, Angular, or Flutter. All web renderers share the @a2ui/web_core foundation for protocol handling."
---
...
<Steps>
  ...
  <Step title="Import the versioned entry point">
    ...
    <Tabs>
      ...
      <Tab title="v0.8">
        ```tsx
        import { MessageProcessor, A2UIRenderer, useA2UI } from '@a2ui/react/v0_8';
        ```
      </Tab>
    </Tabs>
  </Step>
