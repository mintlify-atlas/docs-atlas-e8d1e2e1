---
title: "Building a New A2UI Renderer from Scratch"
...
// v1.0 — release candidate, adds RPC action responses and surfaceProperties
...
<Note>
  The package root (`import ... from '@a2ui/web_core'`) defaults to the v0.8 entrypoint for backward compatibility. For new renderers, always import from the explicit versioned path such as `@a2ui/web_core/v0_9`.
</Note>
